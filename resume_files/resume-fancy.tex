...
\begin{document}
   ...
   \cvtag{Analysis of Algorithms}
    ...
    \cvsection{Experience}
        \cvevent{Associate AWS Developer}{|\cvrepo{Neuraflash}{https://www.neuraflash.com}}{Jul 2025 - Present}{}
...
\smallskip \smallskip
    \newline
    \cvtag{AWS} \cvtag{Amazon Connect} \cvtag{Python} 			\cvtag{Javascript} \cvtag{Salesforce} 
...
created Ontology.
 ...
 \smallskip \smallskip
    ...
    \cvevent{Software Engineering Co Op}{|\cvrepo{Codonics}{https://www.codonics.com/}}{May - Dec 2023}{}
\begin{itemize}
...
\cvtag{Flask}
     ...
     \cvtag{Stripe}
         \newline
      \cvtag{AWS} \cvtag{GCP} \cvtag{Azure} 
