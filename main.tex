...
\definecolor{PrimaryColor}{HTML}{008080} % Teal Blue for headings, links, icons
\definecolor{SecondaryColor}{HTML}{9370DB} % Purple for dates, key skills, awards
\definecolor{ThirdColor}{HTML}{B54745} % Light Gray for background or dividers
